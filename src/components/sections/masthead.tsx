...
import { Menu, Search, Mic, Video, Bell, CircleUserRound, X } from 'lucide-react';
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-lg border border-[#e5e5e5] py-2 z-50">
                  ...
                  <div className="py-2">
                    <Link 
                      href="/settings" 
                      className="block px-4 py-2 hover:bg-[#f2f2f2] text-sm text-[#0f0f0f]"
                    ...
                    <button 
                      ...
                      className="w-full text-left px-4 py-2 hover:bg-[#f2f2f2] text-sm text-[#0f0f0f]"
                    >
                      Sign out
                    </button>
                  </div>
